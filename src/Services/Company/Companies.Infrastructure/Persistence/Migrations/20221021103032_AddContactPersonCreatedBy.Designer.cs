...
namespace Companies.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20221021103032_AddContactPersonCreatedBy")]
    partial class AddContactPersonCreatedBy
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Companies.Domain.ReadModels.SearchIndex", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RegistrationNumber", "CountryCode");

                    b.ToTable("SearchIndexes", "companies");
                });
            ...
            modelBuilder.Entity("Companies.Domain.Aggregates.CompanyAggregate.Entities.ContactPerson", b =>
                {
                    ...
                    b.OwnsOne("Domain.Seedwork.Shared.ValueObjects.CreatedBy", "CreatedBy", b1 =>
                        {
                            b1.Property<Guid>("ContactPersonId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Companies.Domain.ReadModels.SearchIndex", b =>
                {
                    b.HasOne("Companies.Domain.ReadModels.RegistryCenterCompany", null)
                        .WithMany("SearchIndexes")
                        .HasForeignKey("RegistrationNumber", "CountryCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
