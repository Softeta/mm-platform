...
namespace Jobs.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20220714104355_AddContactPersonPosition")]
    partial class AddContactPersonPosition
    {
            ...
            modelBuilder.Entity("Jobs.Domain.Aggregates.JobAggregate.Entities.JobLanguage", b =>
                {
                    ...
                    b.OwnsOne("Jobs.Domain.Aggregates.JobAggregate.ValueObjects.Language", "Language", b1 =>
                        {
            ...
            modelBuilder.Entity("Jobs.Domain.Aggregates.JobAggregate.Job", b =>
                {
                    ...
                    b.OwnsOne("Jobs.Domain.Aggregates.Shared.ValueObjects.Position", "Position", b1 =>
                        {
                            b1.Property<Guid>("JobId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.OwnsMany("Jobs.Domain.Aggregates.JobAggregate.Entities.JobContactPerson", "ContactPersons", b2 =>
                                {
                                    ...
                                    b2.OwnsOne("Jobs.Domain.Aggregates.Shared.ValueObjects.Position", "Position", b3 =>
                                        {
