...
namespace Jobs.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20221026121219_AddProjectWorking")]
    partial class AddProjectWorking
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jobs.Domain.Aggregates.JobAggregate.Job", b =>
                {
                    ...
                    b.Property<bool>("IsSelectionStarted")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Jobs.Domain.Aggregates.JobCandidatesAggregate.Entities.JobCandidatesFilter", b =>
                {
                    ...
                    b.HasKey("UserId", "JobId", "Index");

                    b.ToTable("CandidatesFilter", "jobs");
                });
            ...
            modelBuilder.Entity("Jobs.Domain.Aggregates.JobCandidatesAggregate.JobCandidates", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ShortListActivatedAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.OwnsOne("Jobs.Domain.Aggregates.JobAggregate.ValueObjects.Terms", "Terms", b1 =>
                        {
                            ...
                            b1.OwnsOne("Jobs.Domain.Aggregates.JobAggregate.ValueObjects.ProjectWorkingHours", "ProjectWorkingHours", b2 =>
                                {
                                    b2.Property<Guid>("TermsJobId")
                                        .HasColumnType("uniqueidentifier");
