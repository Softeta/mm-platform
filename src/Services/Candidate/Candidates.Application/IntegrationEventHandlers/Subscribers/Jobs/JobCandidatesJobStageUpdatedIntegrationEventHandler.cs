...
{
    internal class JobCandidatesJobStageUpdatedIntegrationEventHandler : 
        IntegrationEventHandler,
        IIntegrationEventHandler<JobCandidatesJobStageUpdatedIntegrationEvent>
    {
        private readonly IServiceProvider _serviceProvider;

        public JobCandidatesJobStageUpdatedIntegrationEventHandler(IServiceProvider serviceProvider)
        {
        ...
        {
            var @event = JsonConvert.DeserializeObject<JobCandidatesJobStageUpdatedIntegrationEvent>(message);
