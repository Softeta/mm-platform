...
namespace Candidates.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20220720115317_RenameStageToStatus")]
    partial class RenameStageToStatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Candidates.Domain.Aggregates.CandidateAggregate.Candidate", b =>
                {
                    b.OwnsOne("Candidates.Domain.Aggregates.CandidateAggregate.ValueObjects.Document", "Bio", b1 =>
                        {
                    ...
                    b.OwnsOne("Candidates.Domain.Aggregates.CandidateAggregate.ValueObjects.Document", "CurriculumVitae", b1 =>
                        {
                            b1.Property<Guid>("CandidateId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Candidates.Domain.Aggregates.CandidateAggregate.ValueObjects.LegalInformationAgreement", "MarketingAcknowledgement", b1 =>
                        {
                            b1.Property<Guid>("CandidateId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Candidates.Domain.Aggregates.CandidateAggregate.ValueObjects.LegalInformationAgreement", "TermsAndConditions", b1 =>
                        {
                            b1.Property<Guid>("CandidateId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Candidates.Domain.Aggregates.CandidateAggregate.ValueObjects.Document", "Video", b1 =>
                        {
                            b1.Property<Guid>("CandidateId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Candidates.Domain.Aggregates.CandidateAggregate.ValueObjects.Email", "Email", b1 =>
                        {
                            b1.Property<Guid>("CandidateId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Candidates.Domain.Aggregates.CandidateAggregate.ValueObjects.Phone", "Phone", b1 =>
                        {
                            b1.Property<Guid>("CandidateId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Candidates.Domain.Aggregates.CandidateAggregate.ValueObjects.Terms", "Terms", b1 =>
                        {
                            ...
                            b1.OwnsOne("Domain.Seedwork.Models.DateRange", "Availability", b2 =>
                                {
                                    b2.Property<Guid>("TermsCandidateId")
                                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Candidates.Domain.Aggregates.CandidateAggregate.Entities.CandidateCourse", b =>
                {
                    ...
                    b.OwnsOne("Candidates.Domain.Aggregates.CandidateAggregate.ValueObjects.Document", "Certificate", b1 =>
                        {
            ...
            modelBuilder.Entity("Candidates.Domain.Aggregates.CandidateAggregate.Entities.CandidateEducation", b =>
                {
                    ...
                    b.OwnsOne("Domain.Seedwork.Models.DateRange", "Period", b1 =>
                        {
                            b1.Property<Guid>("CandidateEducationId")
                                .HasColumnType("uniqueidentifier");
