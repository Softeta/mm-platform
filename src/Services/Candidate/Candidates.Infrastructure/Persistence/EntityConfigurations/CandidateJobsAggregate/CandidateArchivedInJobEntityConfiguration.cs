...
{
    internal class CandidateArchivedInJobEntityConfiguration : IEntityTypeConfiguration<CandidateArchivedInJob>
    {
        public void Configure(EntityTypeBuilder<CandidateArchivedInJob> builder)
        {
            builder.ToTable("CandidateArchivedInJobs", Constants.DefaultSchema);
